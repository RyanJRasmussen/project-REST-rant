...
Add a comment!
                <form method="POST" action={`/places/${data.place.id}/comment`}>
                    <div className="form-group">
                        ...
                        <input className="form-control" id="author" name="author" required type={"text"}/>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        <label htmlFor="rant">Check for rant</label>
                        <input className="" id="rant" name="rant" type="checkbox"/>
                    </div>
